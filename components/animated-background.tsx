...
export function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    const numberOfParticles = Math.min(window.innerWidth / 10, 100) // Limiter sur les grands écrans
    ...
    class Particle {
      ...
      constructor() {
        ...
        this.color = `rgba(90, 79, 255, ${Math.random() * 0.5 + 0.2})`
      ...
      for (let a = 0; a < particlesArray.length; a++) {
        for (let b = a; b < particlesArray.length; b++) {
          ...
          if (distance < maxDistance) {
            ...
            ctx.strokeStyle = `rgba(90, 79, 255, ${opacity * 0.2})`
            ctx.lineWidth = 1
            ctx.beginPath()
